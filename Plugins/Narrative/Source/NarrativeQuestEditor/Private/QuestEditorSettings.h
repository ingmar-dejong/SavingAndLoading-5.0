...
public:
	...
	UPROPERTY(EditAnywhere, config, Category = "Graph Defaults", noclear)
	TSubclassOf<class UQuestBranch> DefaultQuestBranch;

	UPROPERTY(EditAnywhere, config, Category = "Graph Defaults", noclear)
	TSubclassOf<class UQuestState> DefaultQuestState;
