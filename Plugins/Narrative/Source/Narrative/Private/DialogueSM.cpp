...
FText UDialogueNode_NPC::GetNodeTitleText() const
{
	...
	{
		return FText::FromName(DialogueOuter->GetSpeaker(SpeakerID).SpeakerID);
	}
...
FText UDialogueNode_Player::GetNodeText() const
{
	return OptionText.IsEmpty() ? Text : OptionText;
}
