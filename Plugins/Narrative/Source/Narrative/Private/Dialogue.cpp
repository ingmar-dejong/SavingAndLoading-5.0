...
void UDialogue::DuplicateAndInitializeFromDialogue(UDialogue* DialogueTemplate)
{
	if (DialogueTemplate)
	{
		...
		Speakers = NewDialogue->Speakers;

		SelectReplyShot = NewDialogue->SelectReplyShot;
		SelectReplySettings = NewDialogue->SelectReplySettings;
		PlayerTalkingShot = NewDialogue->PlayerTalkingShot;
		PlayerTalkingSettings = NewDialogue->PlayerTalkingSettings;
	}
}
